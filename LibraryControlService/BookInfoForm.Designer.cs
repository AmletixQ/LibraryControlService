namespace LibraryControlService
{
    partial class BookInfoForm
    {
		...
		private void InitializeComponent()
		{
			...
			BookNameLabel.Location = new Point(134, 12);
			...
			BookAuthorLabel.Location = new Point(138, 110);
			...
			BookDescriptionLabel.Location = new Point(12, 261);
			...
			BuyButton.Size = new Size(187, 38);
			...
			BasketButton.Location = new Point(205, 331);
			BasketButton.Name = "BasketButton";
			BasketButton.Size = new Size(188, 38);
			...
			BookPriceLabel.Location = new Point(10, 166);
			...
			BookGenresLabel.Location = new Point(10, 215);
